      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#1C1C1E] rounded-2xl shadow-xl p-8 border border-[#38383A]">
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-[#38383A]"></div></div>
            <div className="relative flex justify-center text-sm"><span className="px-3 bg-[#1C1C1E] text-[#8E8E93]">or</span></div>
          </div>
          ...
          <button
            ...
            onClick={async () => {
              ...
              try {
                ...
                if (result?.needs_onboarding) {
                  setError('This Google account has no company. Please sign up first.');
                } else {
                  router.push('/dashboard');
                }
              } catch (err: any) {
            ...
            className="w-full py-3 bg-white hover:bg-gray-100 text-gray-800 font-semibold rounded-xl transition disabled:opacity-50 flex items-center justify-center gap-3"
          >
